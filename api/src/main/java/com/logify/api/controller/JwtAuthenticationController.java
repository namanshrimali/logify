...
// Using Spring Authentication Manager we authenticate the username and password.If the credentials are valid, a JWT token is created
// using the JWTTokenUtil and provided to the client.

import com.logify.api.dto.UserDTO;
import com.logify.api.model.JwtRequest;
import com.logify.api.model.JwtResponse;
import com.logify.api.service.JwtUserDetailsService;
import com.logify.api.config.JwtTokenUtil;
